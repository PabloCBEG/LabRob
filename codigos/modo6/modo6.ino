...
// ENCODER
const int encoderi = 3;//conectamos los encoders a los pines de interrupcion del arduino, el encoder derecho al pin 35 y el encoder izquierdo al pin 34
...
void loop() {
  ...
  unsigned long timechange = now - lastime;
  ...
  Serial3.print(mytime); //tiempo desde la anterior medida
  Serial3.print(" ");
  Serial3.print(RPMd);
  Serial3.print(" ");
  Serial3.print(RPMi);
